...
<img class="element-icon" src="/wiki/images/BFT_R1.png" alt="BFT_R1.png">
...
If you wish to enrol in the rotary flight programme you need to have full membership (meaning you need to have the infantryman qualification).

Before joining the first flight training read up about the [flight models](/handbook/flight-models) and configure your game accordingly. Those who only intend to do the copilot's certification are strongly encouraged to use the basic flight model.
...
Learning how to fly helicopters is not easy. When flying in an operation you are responsible for the lives of your passengers. Flying in a dangerous way to impress passengers or due to lacking skill might cause the helicopter to crash and delay the operation for up to twenty minutes while everyone is respawning and setting up again. Deploying a helicopter's weapon systems in an unsafe, not-communicated manner is similarly dangerous to ground units. This is why we require helicopter pilots to earn their licence before being allowed a seat in the cockpit.
...
<img src="/wiki/images/AviationTeam.png" width="250" alt="AviationTeam.png">

## Helicopter Crew

Depending on the Helicopter and the Pilot, the crew consists of up to two people.

- **Pilot** - Flies the Helicopter and is generally in charge, including his cargo. He is responsible for everything in regard to the helicopter from route planning, selection of landing zones and deployment of the guns unless he delegates duties to the Co-Pilot.
...
- **General** - If navigation is offloaded to the Co-Pilot it is mostly handled by giving bearings and distances to upcoming waypoints, although landmarks to orientation can greatly increase the effectiveness. We use the MicroDAGR as a navigation tool ([Guide for MicroDAGR](https://ace3.acemod.org/wiki/feature/microdagr.html)).
  - Terrain Concealment - Utilise the terrain to mask your approach and limit your exposure to enemy locations.
...
- **Supply Drops** - Same as Landing Zones, although due to the sling loaded supplies limiting the helicopter, you need to incorporate this factor when planning a route.
- **Attack Runs** - Proper Ingress is vital to ensure an efficient attack run.
  ...
  - Choose an appropriate Weapon for the target. Conserve heavier, more limited weapons for the time they are most beneficial or if you have to refuel soon anyway.
...
- **Reports** - Report fuel situation and weapon statuses before they become an issue. You should notify the ground elements before you have to return to base.
...
- **Egress** - Before waving off, the pilot must wait for the call from the last man to leave the helicopter. Give the last guy enough time to descend the ropes, then the pilot, or copilot if available, cuts the ropes and leaves the area.

With regard to the methodology for performing a fast rope insertion, the following factors must be observed.

- **Speed** - A maximum speed of 10 km/h must be adhered to, as exceeding it will risk a rope break. In general, you should be completely static when deploying the ropes.
...
- **Transition to Balanced State** (~90-130km/h) when approaching the LZ (depending on chopper and skill of pilots in the formation between 1km and 2km away). Announce that you will switch to Balanced State *before* you do it. Scan the terrain and find your LZ, remember that other pilots need to land here as well.
...
The Pilot can further restrict the ROE. Gunners only fire upon clearance from the Pilot or in order to fight an immediate danger to the Aircraft. Friendly Fire and Civilian Casualties are to be prevented at all times.
...
- **Not to Engage** - Targets not allowed to be engaged.
  - Hospitals, Refugee Camps or the like.
...
Any engagement can be called off by the command / ground teams at all times.
...
- **Main Engine Failure** - Helicopter will descend. Emergency Landing required.
...
- **Tail Rotor Failure** - Loss of the tail rotor.
  - Phase 1:
    ...
    - Low Velocity (below 80) - Rapidly increase forward movement. Alternatively gain altitude while spinning before pulling the nose down to force rapid speed gain.
  ...
  - Phase 3: One of the following:
    ...
    - Perform a Rolling Landing. Turn off wheel brakes and land with speed on a flat surface.
...
- LZ - Landing Zone
- DZ - Drop Zone
- Travel Speed - State of the helicopter where its behaviour resembles that of a plane (>130km/h)
