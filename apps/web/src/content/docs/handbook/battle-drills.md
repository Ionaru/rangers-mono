...
Battle drills are actions, which are performed on the battlefield. These actions do not require a longer set-up or detailed planning. They are performed by individuals or smaller groups, when they are confronted with a scenario, where the individual drill fits the situation. Any member of a unit can initiate a battle drill; it is important that everyone else follows and assists without further vocalisation of how the drill is to be carried out.

## 360° Security

At all times all sectors around the team should be covered. Therefore, it is important to communicate who is covering which sector and generally pay attention, especially when being static. Use the Squad Member HUD to see which directions other members in your squad are covering. It is everybody's responsibility that all sectors are covered and not everyone is looking in the same direction. It is advised that you call out the direction you're covering, when your squad is halting movement.
...
- **Covering** - The soldier in front will provide cover for the other to pass by. The distance to the previous soldier covering should be around 50m. Distance may be ignored when there is a change in terrain. Whenever you are at an entrance to an area which cannot be overlooked by the rest of the Squad, you will provide cover at the entrance.
...
<img class="transparent-fix" src="/wiki/images/Spacing.png" width="150" alt="Spacing.png">
...
- **Adjustment Calls** - The Squad Leader shall always set landmarks and checkpoints in addition to direction and distance. The direction of movement and the general path needs to be communicated to the Squad.

## Reacting to Contact

When running into contact, the following steps apply.
...
- **Cover** - These are the individual steps everyone should go through when he hears or sees contact:
  - If cover is reachable within the next 3 seconds, sprint behind it and go prone.
  - If no cover is close, go prone, when prone crawl or roll slightly away from your initial position.
  - When not in cover see if cover is possible to reach and go for it either by crawling or short sprints followed by going prone and relocating. May use smoke for temporary cover.
...
<img class="transparent-fix" src="/wiki/images/SuppressiveFireGraph.png" width="250" alt="SuppressiveFireGraph.png">
...
- **Suppressive Fire** - Gain fire superiority and force the enemies into cover.
  ...
  - Talking Guns - Ensure a constant volume of fire towards the enemy. Shoot in short bursts and try to fill the gaps in gunfire. If teammates are reloading you speed up the frequency of your bursts to ensure a constant and ongoing fire.
...
<img class="transparent-fix" src="/wiki/images/SuppressiveFire.png" width="250" alt="SuppressiveFire.png">

- **Peel Back** - When peeling back one element will always cover and suppress while others are falling back to take over and cover for the team in front, to leap frog back. It is a reverse move and cover. The goal is to keep suppressing the enemy while falling back and ultimately disengage.
...
- **Initiation** - On order by the leader the ambush will start. When considering the right moment to start the ambush you want to have the following factors working in your favour:
  - Majority of enemies are in the open.
...
- Linear Ambush - All elements are forming a single line facing the enemy. Especially used for hastily assembled ambushes.

<img class="transparent-fix" src="/wiki/images/LinAmbush.png" width="200" alt="LinAmbush.png">

- L-Shape Ambush - An ambush from two sides. Both lines are forming the shape of an L. Usually one element is positioned at the front of the enemy in order to block them and the other element is in their flank. Both elements create a huge crossfire while staying out of each other's fire lines.

<img class="transparent-fix" src="/wiki/images/L-Shape.png" width="250" alt="L-Shape.png">

## Close Quarters Battle

Fighting in close quarters requires a high level of teamwork and coordination. Without a surgical and methodical approach it can easily end in a disaster. There are some ground rules to follow at all times:
...
- **Coordinate** - You need to coordinate each step with each other.
  ...
  - "Got you" or a shoulder tap signals that you have somebody's back for entry.
...
- **Movement** - Always move along a wall and avoid moving in another person's firing line or sector. Slow is smooth and smooth is fast. Moving smooth and at the right speed is important to ensure a precise clearing.
- **Sector by sector** - Proper procedure is required for each room you are clearing.
...
- **General Guidelines**
  ...
  - Gunners do not shoot when the helicopter has landed
...
- **Dropping off Troops**
  ...
  - Pilot lifts off once all passengers have left. The Leader may move up to the Pilot and inform him that all Troops have unloaded, or give a hand signal aimed at the Pilot.
...
- **Fast Roping**
  ...
  - Ropes get deployed.
  - Troops rappel down.
  - Leader is the last to rappel when all of his Troops have already rappelled. He shouts "Last man" to notify the Pilot that he is the last to exit before rappelling himself.
  - Pilot waits for the last man to rappel before flying away.
