...
Communication is an essential factor for team-play. A certain level of standardisation ensures quick and precise communication while limiting misunderstandings. This section features all important Communication-related basics. You will find more situation-based communication guidelines in the relevant sections.

When it comes to Communication there are several core principles:

- **Compact** - Information should always be given with as few words as possible. Keeping it short will ensure the ability for others to have their necessary air time to convey their messages.
...
Based on the information and the availability of your individual accessible channels you have to make a decision on what channel to use. There are some basic guidelines when to use Direct Talk and when to use the Radio.
...
- All relevant information where recipients are out of Direct Communication range or the importance of this information is so high that it needs to be ensured everyone has to receive it
...
The Comm Card can be found in the tabs on the top right-hand side of the map in-game. Do not hesitate to use it.
...
| Channel 4 - MECH NET  | Mechanised/Armoured Net |
...
When talking on the Radio, start each conversation by stating who you are talking to. Recipient from Sender. For Example:
...
- **Clear Comms/Break, break, break** - Signals all listeners to keep radio silence for an incoming priority message.
- **Interrogative** - Used to indicate a following question.
- **Stand by** - Prepare for the following Order.
...
- **Bad Frag** - Warning of a friendly frag grenade thrown in a way that endangers friendlies.
- **Incoming** - Warning of incoming fire. Usually combined with the direction of incoming fire.
- **Cease Fire** - Order to hold and stop fire.
- **Check Fire** - Order to re-identify target to ensure positive identification, used in cases of possible friendly fire.
- **Hold Fire** - Order to hold fire to maintain stealth.

### Personal Status

- **Up** - Report of an operational unit.
- **Reloading** - Report of a unit reloading.
- **Weapon Empty/Dry** - Report of a unit having no ammunition left.
- **Set** - Report of a unit being in a position to cover another unit's movement.

## Status Reports

### Contact Report

A Contact Report contains the following Information:

- **Warning** - Usually "Contact!" is used to alert people to an incoming Contact Report.
...
```
"Contact, Enemy Fire Team, bearing 060, 400 metres."
"Contact, Enemy Patrol, 2 men, North, 400 metres of Alpha - 1, moving eastwards."
```
...
- **Ammunition** - The categorised amount of ammunition for the primary and secondary weapon.
- **Casualties** - Count of currently wounded and dead. Furthermore, the categorised amount of medical gear.
- **Equipment** - The categorised amount of Equipment in regard to Explosives, Rockets, Grenades...
...
- **Optional: Coloured Smoke Reference** - On request of the helicopter crew.

### Request Supply

- **Location** - The Drop Zone you request the Supply Drop to.
- **Drop Zone Details** - Relevant information about the Drop Zone like landmarks that are easy to spot from the air and whether it is hot or cold.
- **Optional: Friendly Location** - Location of friendlies in the area.
- **Optional: Recommended Approach** - Direction you recommend the helicopter to approach the landing zone from.
- **Optional: Coloured Smoke Reference** - On request of the helicopter crew.
...
- **Optional: Recommended Approach** - Direction you recommend the helicopter to approach the target from.
- **Optional: Coloured Smoke Reference** - On request of the helicopter crew.
...
- **Target Description** - What type of target the artillery is called on.
...
- **Splash out** - Warning 5-7 seconds before first impact.
