...
Formations serve multiple purposes: they ensure not only good all-round security but also the reliability of a structured frontline. The available formations, their strengths and weaknesses, and when to use each are covered in [Section 8 - Formations](/handbook/formations). As a leader it is your call which formation fits the ground and the threat.
