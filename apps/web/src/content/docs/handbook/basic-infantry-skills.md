...
It is essential to understand how to read a map and use tools to find your location and any other target location on the map. You must also be able to navigate based on your position and your target position.

### Reading the Map

#### Grid

Arma uses a 6-digit grid system (3x3). Grid coordinates are read in the following way: first 3 right, then up. On a 6-digit grid system one side of a grid is 100 metres which makes a grid an area of 100 x 100 metres.

<img src="/wiki/images/MapGrid.png" width="300" alt="MapGrid.png">

Given that you know your own grid coordinate, you only know that you are in an area the size of 100 x 100 metres. Therefore you need to learn how to take all information displayed on the map to be able to find your exact location.

#### Landmarks and Objects

The map displays Forests, Trees, Buildings, Roads, Water, and many other Landmarks and information. You need to learn how to transfer something you see onto the map and vice versa. Often it can be easier to navigate by landmarks as opposed to bearings and distances.

#### Contour Lines

Contour Lines are information which are displayed based on your zoom level on the map. Each line marks a difference in height. You can add up the number of contour lines between you and a point on the map, then multiply it by the Contour Line Scale and you have the height difference between two points.
...
Notice that it is often enough to know the approximate location on the map for spotting targets, like artillery. This is because the artillery might not be 100% accurate in the first place, and secondly you can call corrections after an initial strike, correcting based on the last fire mission.

### GPS

The GPS is showing your exact grid location on the map and your height above sea level. The GPS overlay (activate with [Right Ctrl] + [M]) also shows the Compass Bearing you are looking at. All information is in real time.
...
| "C" + Number            | Compound when placed on a compound for better reference. |
...
- **Colouring** - Marker in regard to Enemies should be red. Friendly markers e.g. Waypoints should be marked blue. Aviation markers should have a different colour. Generally use consistent colours to help identify markers more efficiently.
...
Rangefinders are tools to measure a distance. We mainly use the Vector 21. It allows you to get the distance [R] and azimuth [Tab] of your target. It takes the slot of the binoculars. Alternatively Laser designators work as well.

<img src="/wiki/images/Vector21.png" width="250" alt="Vector21.png">

In addition, you can find the horizontal distance to a target and the height difference between your location and the target by first tapping [R] followed by holding [R]. Furthermore, you can also get the distance and direction between two points. Therefore you press and hold [R]. Once the circle appears press [Tab] and keep holding [R]. Once the P-1 info appears aim at your second point and release [R]. More functions can be found in the official [ACE3 Wiki](https://ace3.acemod.org/wiki/feature/vector.html).

<img class="transparent-fix" src="/wiki/images/VectorDistance.png" width="500" alt="VectorDistance.png">
...
- **Hard contact versus soft contact** - Soft contact is an enemy contact with the enemy not being alerted or aware of your position. Hard contact is an enemy contact with the enemy being aware of your location and in the process of engaging you or directly being in an engagement with you.
...
**Positive identification** - Do NOT fire unless you have positively identified your target as hostile. Gun sounds and tracer colour might help.
**Is this ours?** - Is this smoke ours? Keep track of friendly positions to identify whether there are hostiles in the area or friendlies.

### Supporting Behaviour

- **Signal** - Maybe use hand signals and see for a response when in doubt. Signal to an unknown contact to identify yourself and look for a response.
- **Listen** - Not only listen to information by your teammates. Also listen for voices and gun shots. When you hear a gun shot you often hear two different sounds. First you hear a loud bang followed by a delayed quieter bang. The first bang is the bullet passing faster than the speed of sound and the resulting supersonic shockwave. The second quieter bang is the actual gun fire sound since its sound is slower than the bullet.
...
- **Spacing** - Spacing is important. Unit cohesion requires a certain proximity between units although bunching up will maximise damage by explosives. Therefore ensure you are always close enough to be able to see and interact with them and on the other hand avoid bunching up.

### Cover and Concealment

- **Cover** - Any object or terrain aspect which is capable of stopping bullets and shrapnel. Cover can be trees, solid walls, vehicle wrecks, dead bodies and many more things.
- **Concealment** - Anything which denies you getting spotted by the enemy.

#### Guidelines

- **Utilise Cover** - Always move from cover to cover. Whenever you are moving you should be aware of potential cover around you, to immediately take effective cover, in case of incoming fire.
  - **Out of contact** - Whenever you hold movement you should crouch down. Seek concealment.
  - **In contact** - Only strictly move from cover to cover. When caught out of cover, go prone. Sprint from cover to cover when moving. Generally always go prone when holding to achieve a maximum coverage. Afterwards, slowly increase your exposure when aiming to return fire.
  - **Urban environment** - Going prone might not be viable at times, because of the lack of mobility versus effective cover.

#### Stances

Arma 3 offers a large variety of vertical ([Ctrl] + [W] or [S]) and horizontal ([Ctrl] + [A] or [D]) stance adjustments. Make sure to minimise your exposure by utilising the different stances. There are three basic vertical stance categories and each comes with 3 versions (low/normal/high).
...
Note that stances influence not only exposure but also accuracy, movement speed, and stamina.
...
Your stamina is influenced by the terrain you are operating in and the weight of your equipment. Climbing up a hill is more exhausting than moving in flat terrain. Fatigue will lead to great loss of accuracy. Having the weapon lowered while moving will also lower exhaustion. A soldier should never carry more than around 35 kg. For normal out of combat movement ensure that you are normally walking with your weapon lowered for maximum stamina efficiency.

### Obstacles

There are a large variety of obstacles. Generally people find a way around them. One important aspect is how to utilise holes in walls. Obstacles often mean that you need to put yourself in a disadvantageous spot to pass them. Therefore you should minimise the time of your exposure.
...
Always take the opposite side to the person in front of you.
...
- **Team Colour** - You can change your team colour under self interaction, team management...
- **Radio Template** - You can select a radio frequency profile with self interact, team management...
- **Change Call Sign** - You can change your call sign under self interaction, team management...
...
- **Awareness** - Do not cross somebody's line of fire. If you have no choice alert the person before doing it.

### Rules of Engagement

- **Default ROE** - Unless told otherwise.
  - Only open fire in defence of yourself or your teammates.
    - Proximity: Close enemies are posing a higher threat
    - Awareness: Enemies who are not aware of our presence do not pose a threat.
    - Potential: Even if proximity and awareness are not given, the enemy might still pose a high threat to other team elements.
...
Understanding bullet trajectory is important when engaging targets at range. Bullets drop over range. It is important to know the range of your target to adjust your aim.

<img class="transparent-fix" src="/wiki/images/Trajectory.png" alt="Trajectory.png" width="300">

Zeroing your weapon, meaning adjusting the weapon sights to a certain range, can be helpful. Otherwise, you might have to take the range the weapon is configured on and either aim above or below the target to hit. If your weapon sights allow you can zero them to certain ranges using [Page Up] and [Page Down]. You will find the distance your weapon sight has been configured for on the HUD. Zeroing might be more relevant for longer engagement distances in regard to firearms, although it is extremely important for heavier projectiles with higher drop rate like 40mm grenades or even rockets.

<img src="/wiki/images/WeaponRanging1.png" width="300" alt="WeaponRanging1.png">

Bullets and other projectiles need to travel to their destination. They are not instantly there. Especially when shooting at moving targets you need to mind the travel time of the bullet, meaning that you need to aim ahead of your target in its direction of movement. Tracers might help to track your own fire or the fire of friendlies. If you are paired up with a machine gunner trace his fire by looking at the tracers and call corrections if needed.

Factors influencing your accuracy:

- **Stamina** - Fatigue has a negative impact.
- **Stance** - Influences accuracy.
- **Breath Control** - Holding your breath increases accuracy temporarily. Holding it for too long will massively decrease your accuracy in the short term.
- **Injuries/Pain** - Wounds and pain negatively influence your accuracy.
- **Weapon Resting** - Using bipods or resting your weapon will increase your accuracy [C].

#### Reloading and Ammunition

Knowing when to reload can save your life. There are two different types of reload:
...
Keep track of your ammunition. The HUD will only display the number of magazines you have regardless of them being full or partially empty. You can check the current state of your magazine in your weapon by pressing [L Ctrl] + [R]. It will display a categorised number of bullets in your magazine. Partial magazines can be repacked, meaning that you will pack all magazines together that you end up with as many full magazines as possible out of the number of bullets you have. Repacking magazines can be done through ACE self interact. You should do this whenever the situation allows. Since it takes a while to do, make sure that you do not start right before the order to move out. You do not own your ammunition. It belongs to the team, the same as all your gear is shared if required.
...
Our policy allows minor gear customisation. Everything else is being handled by loadouts. Generally you are allowed to modify your weapon sight which is done by an action box at the base of operations. Green coloured equipment is free to use for everyone, other colours require permission.

### Explosives

Explosives are handled by the ACE interaction and self interaction menus. To place a charge use self interact and follow the menu. Once you place a charge you need to select a trigger. Therefore interact with the charge and select the desired trigger. If you do not carry any triggers, you can always choose a timer. Communicate when you place a charge, when it is hot, and when you are about to blow it. You can defuse mines and other explosives by crawling towards them and interacting with them. More information can be found [here](/handbook/echo-platoon-support).
...
- **Disposable Launchers** - Usually need to be prepared by pressing the reload button. This will bring up the sights and allow you to shoot. Once fired the used tube will be automatically dropped when switching to another weapon. They are one time use only. Disposable Launchers are for example: M136, M72, RPG-26.
...
- **Airburst** - HE Ammunition can be set to Airburst. Set the Airburst Range before firing and fire the rocket above your enemy. Airburst is maximising the effectiveness on soft targets (infantry).
...
- **Fire Mode** - The Javelin provides two modes: Top and Direct Fire. When using Top Fire the rocket will take a trajectory which leads to it hitting the target directly from above. Direct Fire will make the rocket climb to travelling height before directly flying at the target ([CTRL] + [TAB]).
...
<span>
  <a href="/wiki/images/rpg7optic.png" target="_blank"><img src="/wiki/images/rpg7optic.png" alt="RPG-7 Optic"></a>
  <a href="/wiki/images/rpg7optic2.png" target="_blank"><img src="/wiki/images/rpg7optic2.png" alt="RPG-7 Optic"></a>
</span>
...
- **Freefall** - Usually high altitude jump with steerable parachute.
  ...
  - **HAHO** - High Altitude High Opening
    ...
    - Open parachute using following guidelines:
      - 800m altitude for each 1 km of distance from dropzone (note that wind will impact your gliding)
