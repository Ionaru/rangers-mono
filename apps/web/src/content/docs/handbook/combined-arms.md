...
More often than not our operations are conducted by a diverse force. While everything is centred around the Infantry Platoon as the core of our force, there can be a variety of support-oriented units serving alongside it.
...
- **Embedded** - Echo is embedded in the main Platoon. They are handled as a regular squad, but with a special set of purposes and capabilities.
...
- **On Station / Overwatch** - Aviation Unit is in proximity of the AO ready to respond to requests.
