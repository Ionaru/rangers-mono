...
<img class="element-icon" src="/wiki/images/BFT_E1.png" alt="BFT_E1.png">

## Introduction

Echo is embedded in the Main Platoon. Their main tasks include covering regular elements, protecting flanks and providing effective fire support.

## Composition

- **Combat Engineer** - Echo Team Leader and trained Engineer. Proficient in the following fields of work:
...
- **Weapons Specialist** - Operator of Echo's Heavy Weapons, which include:
...
<img src="/wiki/images/Echo_2.png" width="250" alt="Echo_2.png">

### Engineer Skills

Skills a Combat Engineer needs to be able to bring onto the battlefield.

- **Entrenching** - Equipped with an Entrenching Tool the Combat Engineer can dig trenches. Used over ACE Self-Interaction he can dig either a small or a big trench. These can be positioned freely, although they require ground that can be moved, like sand or grass, it does not work on concrete and such. The Entrenching Tool allows you to continue constructing unfinished Fortifications.
- **Fortification** - Equipped with an Entrenching Tool and Construction Tool the Combat Engineer can construct Fortifications as long as there are available resources. Used over ACE Self-Interaction he can construct Fortifications. Each Fortification will cost resources depending on its complexity. Possible Fortifications include small bunkers, various sandbag walls, tank traps and razor wire.
...
- **Repairing Vehicles** - Unless you just switch tyres, Repairing requires a Tool Kit. These can usually be found inside the vehicles. Repairing is done by interacting with the Vehicle with ACE Interaction.
- **Deployment of Explosives** - Explosives are placed by using ACE Self-Interaction. Often Explosives require arming after placing which is being done by ACE Interaction with the Explosive. The Combat Engineer carries manual tickers (Clacker).
- **Disposal of Explosives** - Depending on the type of Explosive you face, there are different requirements. Generally it follows a certain procedure.
  ...
  - Approach - Carefully crawl towards the Explosives, especially if you suspect a trigger like a pressure plate and such.
...
Furthermore, you need to be proficient with Map Tools, details can be found in [Section 4 Basic Infantry Skills](/handbook/basic-infantry-skills).

#### General

- **Required Tools** - Following Tools are required for effective mortar deployment and usage:
  - Map Tools - Direction and Distance.
  - 82mm Rangecard - Providing Ballistic Information.
  - Pen & Paper - You eventually need to make some notes and calculations.
...
- **Ammunition** - The Mortar must be manually reloaded with ACE Interaction. Ammunition is stored in a box which can be carried. There are three types of Ammunition available:
  - HE
  - Smoke
  - Illumination
...
Assuming you received a Target or you just prepare for potential Targets during downtimes. You need to go through the following steps:

**Step 1: Collect Target Information**

- Find your exact location on the Map.
- Find the target location on the Map.
- Use Map Tools and get the direction (in Mils) and distance in metres.
...
**Step 2: Choose appropriate Charge**

- Charge influences the amount of explosive force used to propel the Mortar Round.
...
Use the 82mm Rangecard and acquire all relevant information. Given the distance to the target and charge, you need to acquire the following information:

- Elevation
  - Base Setting
- Elevation adjustment for 100m Height Difference
  - Scales linearly, e.g. 50m Height Difference means half of the adjustment value needed
...
Depending on Reports of your effectiveness on the Target you might need to adjust and be called to fire again.

## Motorised/Mechanised

Echo might operate with a Vehicle. Usually in order to assist with transporting equipment or enhancing firepower due to vehicle weaponry. This section will be about how to utilise and deploy a vehicle like a HMMWV.

- **Vehicle Roles** - Depending on the Vehicle the roles may switch. For a HMMWV with an M2 Machine Gun the Weapons Specialist should not be the Gunner of the M2 per se. Being a passenger allows him to deploy his MMG (for example) while his Asst. Weapon Specialist is able to operate the mounted M2. The Combat Engineer is driving the HMMWV. The Weapon Specialist is sitting in the backseat behind the driver.

<img src="/wiki/images/HMMWV_Hold.png" width="500" alt="HMMWV_Hold.png">

- **Holding Vehicle** - Hold the vehicle angled in the centre of the road. That provides a lot of cover, assuming the contact is coming from the front. It should be angled to provide a maximum of cover, while being able to move forward or go in reverse without switching between them.
